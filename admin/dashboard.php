...
<body>
   <div class="databox">
        <div class="box roombookbox">
          <h2>Total de quartos reservados</h1>  
          <h1><?php echo $roombookrow ?> / <?php echo $roomrow ?></h1>
        </div>
        <div class="box guestbox">
        <h2>Total de pessoas</h1>  
          <h1><?php echo $staffrow ?></h1>
        </div>
        <div class="box profitbox">
        <h2>Lucro</h1>  
          <h1><?php echo $tot?> <span>R$</span></h1>
        </div>
    </div>
    <div class="chartbox">
        <div class="bookroomchart">
            <canvas id="bookroomchart"></canvas>
            <h3 style="text-align: center;margin:10px 0;">Quartos Reservados</h3>
        </div>
        <div class="profitchart" >
            <div id="profitchart"></div>
            <h3 style="text-align: center;margin:10px 0;">Lucro</h3>
        </div>
    </div>
</body>
