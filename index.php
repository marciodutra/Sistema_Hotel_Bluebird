    ...
    <section id="auth_section">
        ...
        <div class="auth_container">
            ...
            <div id="Log_in">
                <h2>Login</h2>
                <div class="role_btn">
                    <div class="btns active">Usuário</div>
                    <div class="btns">Funcionários</div>
                </div>
                ...
                <form class="user_login authsection active" id="userlogin" action="" method="POST">
                    ...
                    <button type="submit" name="user_login_submit" class="auth_btn">Logar</button>

                    <div class="footer_line">
                        <h6>Não tem uma conta? <span class="page_move_btn" onclick="signuppage()">Inscrever-se</span></h6>
                    </div>
                </form>
                ...
                <form class="employee_login authsection" id="employeelogin" action="" method="POST">
                    ...
                    <button type="submit" name="Emp_login_submit" class="auth_btn">Logar</button>
                </form>
            ...
            <div id="sign_up">
                ...
                <form class="user_signup" id="usersignup" action="" method="POST">
                    ...
                    <button type="submit" name="user_signup_submit" class="auth_btn">Inscrever-se</button>

                    <div class="footer_line">
                        <h6>Já tem uma conta? <span class="page_move_btn" onclick="loginpage()">Logar</span></h6>
                    </div>
                </form>
            </div>
    </section>
